...
class Dynamic_array {
	...
	friend Dynamic_array operator+ (const Dynamic_array&, const Dynamic_array&);
...
Dynamic_array& Dynamic_array::sort() {
	int n = size;
	for(int i = 0; i<=n-2;++i)
...
Dynamic_array operator+ (const Dynamic_array& vec1, const Dynamic_array& vec2) {
	Dynamic_array ret;
